...
matrix_solnJ1_1, dataJ1_1 = mi.jacobian(matrix1, .6, tol)
matrix_solnJ1_2, dataJ1_2 = mi.jacobian(matrix1, 1, tol)
matrix_solnJ1_3, dataJ1_3 = mi.jacobian(matrix1, 1.4, tol)

matrix_solnJ2_1, dataJ2_1 = mi.jacobian(matrix2, .6, tol)
matrix_solnJ2_2, dataJ2_2 = mi.jacobian(matrix2, 1, tol)
matrix_solnJ2_3, dataJ2_3 = mi.jacobian(matrix2, 1.4, tol)
...
#Jacobian, CSV2
axs[1,0].imshow(matrix1, cmap = 'gray')
plt.axis('off')
