...
matrix_solnG1_1, dataG1_1 = mi.gauss_seidel(matrix1, .6, tol)
matrix_solnG1_2, dataG1_2 = mi.gauss_seidel(matrix1, 1, tol)
matrix_solnG1_3, dataG1_3 = mi.gauss_seidel(matrix1, 1.4, tol)

matrix_solnG2_1, dataG2_1 = mi.gauss_seidel(matrix2, .6, tol)
matrix_solnG2_2, dataG2_2 = mi.gauss_seidel(matrix2, 1, tol)
matrix_solnG2_3, dataG2_2 = mi.gauss_seidel(matrix2, 1.4, tol)
